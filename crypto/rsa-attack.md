...
* 如果`(a*b)%c==1` ，那么a和b互为对方模c的模逆元/数论倒数，也写作![mod\_inv](../.gitbook/assets/1531107643807.png) 。
...
![ext\_euclid](../.gitbook/assets/1531578488892.png)
...
![CRT](../.gitbook/assets/1531585006464.png)
...
![CRT2](../.gitbook/assets/1531591884497.png)
...
* python
  * gmpy2库
    * Windows：可从[https://pypi.org/project/gmpy2/\#files](https://pypi.org/project/gmpy2/#files) 直接下载已编译的安装包。
...
在线查询：[https://factordb.com/](https://factordb.com/)
...
Rabin加密是RSA的衍生算法，e==2是Rabin加密典型特征，可以百度或阅读 [https://en.wikipedia.org/wiki/Rabin\_cryptosystem](https://en.wikipedia.org/wiki/Rabin_cryptosystem) 以了解到详细的说明，这里只关注解密方法。一般先通过其他方法分解得到p，q，然后解密。
...
![Wiener&apos;s Attack](../.gitbook/assets/1531634016545.png)
...
工具：[https://github.com/pablocelayes/rsa-wiener-attack](https://github.com/pablocelayes/rsa-wiener-attack)
...
参考 [https://www.40huo.cn/blog/rsa-private-key-recovery-and-oaep.html](https://www.40huo.cn/blog/rsa-private-key-recovery-and-oaep.html) 修复存储私钥的文件，得到p和q。
...
![Baby RSA](../.gitbook/assets/1531637468518.png)
...
使用命令从PEM文件（Privacy-Enhanced Mail 是用于存储和发送密钥、证书等数据的文件格式）中解析公钥对\(n,e\)，n可在线查询 \([http://factordb.com/](http://factordb.com/)\) 到质因子，分解n得到p和q，便能够计算欧拉函数值及解密指数，从而解密。
